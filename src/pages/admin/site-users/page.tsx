    ...
    <section className={cn(adminPageSectionClass, "space-y-5 pt-4")}>
      <AdminCard className="p-4">
        ...
        <div className={adminTableShellClass}>
          <div className="grid grid-cols-[1.2fr_1fr_0.9fr_0.9fr_0.6fr_4.5rem] gap-2 bg-slate-100/80 px-3 py-2 text-[11px] font-semibold uppercase tracking-wide text-slate-500 dark:bg-slate-800/70 dark:text-slate-300/80">
            <span>User</span>
...
function UserRow({
  ...
  return (
    <div className="grid grid-cols-[1.2fr_1fr_0.9fr_0.9fr_0.6fr_4.5rem] items-center gap-2 border-t border-slate-200/70 px-3 py-2.5 text-xs dark:border-slate-700/60">
