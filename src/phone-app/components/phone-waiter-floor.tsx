...
import { Bell, LogOut, MapPinned, Users } from "lucide-react";
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    "relative box-border flex h-[7.25rem] w-full shrink-0 flex-col items-center justify-center gap-1 overflow-hidden rounded-2xl border-2 px-2 transition active:brightness-110",
                    colors.bg,
                    colors.border,
