-- Telefon / POS me llogari: Supabase → SQL Editor.
-- Zgjidh GJITHÇKA (Ctrl+A) pastaj Run. Pa DO/EXECUTE; pa SELECT ... INTO (më pak gabime në editor).
-- Ose: sql_supabase_editor_01 + sql_supabase_editor_02
--
