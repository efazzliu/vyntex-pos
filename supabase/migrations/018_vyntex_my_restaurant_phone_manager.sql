-- Phone managers must not claim venue ownership via vyntex_my_restaurant metadata branches.
-- Trup i thjeshtë PL/pgSQL (pa DO/EXECUTE, pa SELECT INTO) për SQL Editor.
