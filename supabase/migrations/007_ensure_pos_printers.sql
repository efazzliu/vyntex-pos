-- Idempotent: ensures network/BT/USB printers can be saved when using the anon key.
-- Apply in Supabase if "Shto Printer" / add printer fails with RLS or missing relation.
